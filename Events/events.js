...
const slides = [
  ...
  {
    url: "/Events/events_img/1647331923111 (1).jpg",
    heading: "",
    tagline: "",
  },
  {
    url: "/Events/events_img/1647411439750.jpg",
    heading: "",
    tagline: "",
  },
  {
    url: "/Events/events_img/1635507414673 (1).jpg",
    heading: "",
    tagline: "",
  },
];
  ...
  await fetch(currScript.src)
    .then(function (response) {
      if (!response.ok) {
        ...
        alert("Can't get the contents of the script. Try again please");
      }
